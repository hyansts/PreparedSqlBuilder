...
public class SqlAggregator {
	...
	//TODO: talvez faça sentido retornar new DbTableField?
	public static String avg(String field) { return String.format("AVG(%s)", field); }
	public static String max(String field) { return String.format("MIN(%s)", field); }
	public static String min(String field) { return String.format("MAX(%s)", field); }
